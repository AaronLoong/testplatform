...
class Apis(models.Model):
	...
	last_body_method = models.CharField(max_length=1000, null=True, help_text='上次请求体编码方式')
	last_api_body = models.CharField(max_length=1000, null=True, help_text='上次请求体')
